...
DYNAMIC_CONFIG_DEF = {
    ...
    constants.CONFIG_OPTION_PROXY_LOCK_DISCOVERY_ADDRESS: (constants.CONFIG_SECTION_REVERSE_PROXY, 'boolean', False),
    constants.CONFIG_OPTION_PROXY_DISCOVERY_URL_MANUAL: (constants.CONFIG_SECTION_REVERSE_PROXY, 'string', ""),
    constants.CONFIG_OPTION_PROXY_ALLOW_TRANSCODING: (constants.CONFIG_SECTION_REVERSE_PROXY, 'boolean', False),
    ...
    constants.CONFIG_OPTION_MONITOR_SCAN_MAX_TASKS: (constants.CONFIG_SECTION_MONITOR, 'int', constants.DEFAULT_MONITOR_SCAN_MAX_TASKS),
    constants.CONFIG_OPTION_MONITOR_SCAN_BATCH_SIZE: (constants.CONFIG_SECTION_MONITOR, 'int', constants.DEFAULT_MONITOR_SCAN_BATCH_SIZE),
    ...
    constants.CONFIG_OPTION_115_API_PRIORITY: (constants.CONFIG_SECTION_115, 'string', 'openapi'),
    ...
    constants.CONFIG_OPTION_ETK_SERVER_URL_MANUAL: (constants.CONFIG_SECTION_115, 'string', ""),
    ...
    constants.CONFIG_OPTION_AI_JOKE_FALLBACK: (constants.CONFIG_SECTION_AI_TRANSLATION, 'boolean', False),
